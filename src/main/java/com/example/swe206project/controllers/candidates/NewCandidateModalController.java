...
//
    ...
    void onAddClick(ActionEvent event){
        ...
        if (
            ...
            File newCandidateCV = new File("src/main/resources/com/example/swe206project/CandidatesCVs/" + newCandidateId + ".pdf");

            // creating the new modal and inserting it to the database
            Candidate newCandidate = new Candidate(newCandidateName, newCandidateId,
                                newCandidateEducationLevel, newCandidateExperienceYears,
                                newCandidateGender, newCandidateCV);
